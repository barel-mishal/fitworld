    ...
    "section 1 unit 1 level 1": [
      ...
      },
      {
        ...
        metadata: {
          ...
          title: "Question 4",
          question:
            "Which type of nutrient is required in smaller amounts but is crucial for body functions like immune support and bone health?",
          options: [
            "Macronutrients",
            "Carbohydrates",
            "Micronutrients",
    ...
    "section 1 unit 1 level 2": [
      ...
      },
      {
        ...
        metadata: {
          ...
          options: [
            "They reduce the body's need for energy",
            "They play a crucial role in providing energy",
            "They have no impact on energy levels",
            "They only affect mental clarity",
          ],
          correctAnswer: 1,
        },
      },
      {
        ...
        metadata: {
          ...
          question:
            "Which of the following is a dietary factor in the development of type 2 diabetes?",
          options: [
      ...
      },
      {
        ...
        metadata: {
          ...
          question:
            "Why is hydration important for energy and mental performance?",
          options: [
            "It decreases mental clarity",
            "It has no effect on energy levels",
            "It is essential for maintaining cognitive function and energy",
    ...
    "section 1 unit 1 level 3": [
      ...
      },
      {
        ...
        metadata: {
          ...
          title: "Question 3",
          question:
            "What is a recommended strategy to prevent calcium deficiency?",
          options: [
      ...
      },
      {
        ...
        metadata: {
          ...
          title: "Question 4",
          question:
            "Who should you consult for personalized advice on nutritional deficiencies?",
          options: [
            "A friend",
