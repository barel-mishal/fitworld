...
import { NextTrackFood, TrackFood } from "~/components/TrackFood/trackFood";
      ...
      >
        <div q:slot="header" class="p-2">
          <AppLink route="/client/(main)/play/">
            <p class="flex items-center gap-2 font-bold tracking-wider">
              <PhArrowBendUpLeft class="fill-rose-300" />
              <span class="text-rose-50">End Eating Tracking Seesion</span>
            </p>
          </AppLink>
        </div>
