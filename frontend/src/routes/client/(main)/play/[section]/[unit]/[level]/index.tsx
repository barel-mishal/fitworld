...
export default component$(() => {
  ...
  return (
    <div
      class={cn(
        "grid h-screen grid-rows-[40px,1fr,60px] gap-3 overflow-y-auto p-2 bg-gray-950 font-roundsans tracking-wide text-gray-50",
        ""
      )}
    >
      <div
        q:slot="header"
        class="grid grid-cols-[auto,1fr,auto] content-center items-center gap-3 bg-gray-950 text-gray-400"
      >
