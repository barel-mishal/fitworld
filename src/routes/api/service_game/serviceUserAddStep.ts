...
// import { serverPrompts } from "./serviceGPTPrompts";
    ...
    async function main() {
      const completion = await openai.chat.completions.create({
        messages: [
          {
            role: "function",
            content: "create a step with text",
            name: "step_text",
          }
        ],
        ...
        functions: [
          {name: "step_text", description: "Create a step with text", parameters: { title: "string", type: "object"}},
        ]
      });
